...
public interface MatchupRepository extends JpaRepository<Matchup, MatchupId> {
    ...
    List<MatchupMetaDTO> getCurrentLeagueMatchups(@Param("currLeague") int currLeague);
    ...
    List<MatchupMetaDTO> getAllTeamMatchups(@Param("currLeague") int currLeague, @Param("currTeam") String currTeam);
